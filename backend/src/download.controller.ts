...
const PERMANENT_GITHUB_APK_URL =
  'https://github.com/DhruvHarani1/hms/releases/download/v2.3.0-apk/hostel-app-v2.3.0.apk';
...
export class DownloadController {
  ...
  getVersion() {
    return {
      latestVersion: process.env.APP_LATEST_VERSION || '2.3.0',
      // Bumped to 2.3.0 (Ludo art/animation/sound, expo-audio native module) — force-gated
      minRequiredVersion: process.env.APP_MIN_REQUIRED_VERSION || '2.3.0',
