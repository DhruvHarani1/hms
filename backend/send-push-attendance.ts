...
async function main() {
  ...
  const title = '📢 Important: Default Meal Attendance';
  const body = "To simplify dining hall check-ins, all student meal attendance is now marked as 'Present' by default. If you will be skipping any upcoming meals, please opt out under the 'My Meals' tab to avoid food wastage.";
